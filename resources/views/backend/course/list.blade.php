...
@section('page_heading','List Course')
@section('section')
    <div class="col-sm-12">
                ...
                <form method="get" action="{{URL::route('exam')}}" novalidate="">        
                    ...
                    <div class="col-md-2">
                        <div class="form-group">
                            ...
                            <input class="form-control eLearningDatepicker" data-provide="datepicker" data-date-format="dd/mm/yyyy" name="start_date" id="start_date" type="date" value="{{ $create_date }}">    
                    ...
                    <div class="col-md-2">
                        <div class="form-group">
                            ...
                            <input class="form-control eLearningDatepicker" data-provide="datepicker" data-date-format="dd/mm/yyyy" name="end_date" id="end_date" type="date" value="{{ $end_create_date }}">    
                ...
                @foreach($all_data as $value)
                     ...
                     <td style="vertical-align: middle; text-align:center;"><input type="checkbox" onclick="rowCheck(this)"  name="rowCheck" value="{{ $value->id }}" ></td>
                      <td style="vertical-align: middle; ">{{ $value->id }}</td>               
                       ...
                       <td style="vertical-align: middle;">{{ $value->introtext }}</td>                     
                       <td style="vertical-align: middle;"><?php echo date("d/m/Y",$value->create_date); ?></td>
                       <td style="vertical-align: middle; text-align:center;">
                        <a href="{{ URL::route('course/edit', array('id' => $value->id)) }}" class="glyphicon glyphicon-pencil"></a>
                        &nbsp;&nbsp;|&nbsp;&nbsp;
                        <a style="cursor:pointer;" onclick="deleteById('{{$value->id}}')" value="{{$value->id}}" class="glyphicon glyphicon-trash"></a>
                        &nbsp;&nbsp;|&nbsp;&nbsp;
                        <a href="{{ URL::route('course/list-lesson', array('eId' => $value->id)) }}" class="glyphicon glyphicon-question-sign"></a>
                        &nbsp;&nbsp;|&nbsp;&nbsp;
                        <a href="{{ URL::route('course/create-lesson', array('eId' => $value->id)) }}" class="glyphicon glyphicon-plus"></a>
             ...
             <div class="col-md-6">
               <ul class="pagination" >
                 <li><a onclick="deleteAll()" style="cursor:pointer;"><i class="glyphicon glyphicon-remove-circle"></i>&nbsp;Delete all</a></li>
                  <li><a href="{{URL::route('course/add')}}" style="cursor:pointer;"><i class="glyphicon glyphicon-plus-sign"></i>&nbsp;Add new</a></li>
               </ul>
             </div>
             <div class="col-md-6">
                <div align="right">
