        ...
        <div class="panel-body">
          ...
          <div class="col-md-3">
            <div class="thumbnail no-border no-boxshadow">
              <div class="thumb mt-10 mb-10"><span class="text-semibold mb-10">Profile picture</span> <img alt="" class="mt-10" src="{{asset('frontend/images/user-no-avatar.png')}}"></div>
              <div class="caption">
                <button class="btn btn-default btn-ladda btn-ladda-progress" data-spinner-size="20" data-style="expand-left" type="button"><span class="ladda-label">Upload new picture</span><span class="ladda-spinner"></span>
