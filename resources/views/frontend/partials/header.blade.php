                ...
                <nav class="header-logo-account__right">
                    <ul class="header-logo-account__sundry">
                        <li class="header-logo-account__sundry-item">
                            <a class="header-logo-account__sundry-main-link" href="{{route('home.about')}}">Giới
                                thiệu</a>
                        </li>
                        <li class="header-logo-account__sundry-item">
                            <a class="header-logo-account__sundry-main-link" href="{{route('home.become_instructor')}}"><strong>Hợp
                                    tác giảng dạy</strong></a>
                        </li>
                        <li class="header-logo-account__sundry-item">
                    ...
                    <div class="header-logo-account__user-nav">
                        @if(!Auth::guard('frontend')->check())
                            <div class="header-logo-account__user-nav-item">
                                <strong>
                                    <a class="header-logo-account__user-nav-main-link--alpha"
                                       href="{{route('user.register')}}"><span>Đăng ký thành viên</span></a>
                                </strong>
                            </div>
                        @else
                            <div class="header-logo-account__user-nav-item">
                                <a class="header-logo-account__user-nav-main-link--alpha-with-dropdown"
                                   data-view="touchOnlyDropdown" data-dropdown-target="#user-nav-dropdown"
                                   href="{{route('user.author')}}">
                                ...
                                <div class="header-logo-account__user-nav-dropdown" id="user-nav-dropdown">
                                    <ul class="hub-header-dropdown">
                                        ...
                                        <li>
                                            <a class="hub-header-dropdown__bottom"
                                               href="{{route('user.author_account')}}">
                                                Thiết lập
                            ...
                            <div class="header-logo-account__user-nav-item">
                                <a class="header-logo-account__user-nav-main-link--cart" rel="nofollow"
                                   href="{{route('user.author_notifications')}}">
                        ...
                        <div class="header-logo-account__user-nav-item">
                            @if(Auth::guard('frontend')->check())
                                <a class="header-logo-account__user-nav-main-link--omega"
                                   href="{{route('user.logout')}}">Thoát</a>
                            @else
                                <a class="header-logo-account__user-nav-main-link--omega"
