<<<<<<< HEAD:resources/views/templates/default/index.blade.php
<!DOCTYPE html>
<!--[if IE 8]> 
                              ...
                              <div class="faceted-search js-faceted-search" data-view="pjaxFacetedSearch">
                                 <div class="grid-container">
                                    ...
                                    <div class="content-l -size-scale-tablet content-right">
                                       <!--Courses List-->
                                       @include('templates.default.course.courses-list')
                                       <!--#Courses List-->
                                    </div>
                                 </div>
                              </div>
...
>>>>>>> ef80d79dc14a0b8860a15eb7c11267d956a9e4e2:resources/views/frontend/index.blade.php
      </html>