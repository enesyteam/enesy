...
(1, 0, 'Java', '', 'thảo luận về ngôn ngữ lập trình Java', '/2016/12/30/images.png', 'ducnvna@gmail.com', 20161230, 0, 0, 1),
...
CREATE TABLE `tbl_member` (
  ...
  `is_learning` tinyint(2) NOT NULL DEFAULT '1' COMMENT '1. là học sinh, 0. ko phải học sinh',
  `sex` varchar(45) DEFAULT NULL,
  `dob` date DEFAULT NULL,
  `local_time_id` tinyint(4) DEFAULT NULL,
  `location_id` tinyint(4) DEFAULT NULL,
  `currency` varchar(225) NOT NULL DEFAULT 'VND',
  `social` varchar(225) DEFAULT NULL,
  `phone` varchar(15) DEFAULT NULL,
  `address` varchar(255) DEFAULT NULL,
  `technical_skill` varchar(45) DEFAULT NULL,
  `japanese_skill` varchar(45) DEFAULT NULL,
