...
<html lang="en" class="ie8 no-js">
   ...
   <html lang="en" class="ie9 no-js">
      <![endif]-->
      <!--[if !IE]><!-->
      <html class="js cors svg" lang="<?php echo e(config('app.locale')); ?>">
         <!--<![endif]-->
         <!-- HEAD -->
         <head>
            <meta charset="utf-8" />
            ...
            <link href="<?php echo e('templates/default/assets/css/normalize.css'); ?>" rel="stylesheet" type="text/css" />
            <link href="<?php echo e('templates/default/assets/css/style.css'); ?>" rel="stylesheet" type="text/css" />
            <link href="<?php echo e('templates/default/assets/css/custom.css'); ?>" rel="stylesheet" type="text/css" />
            <link href="<?php echo e('templates/default/assets/css/layout.css'); ?>" rel="stylesheet" type="text/css" />
         </head>
         <!-- #HEAD -->
         <body>
            <div class="page">
                  ...
                  <div class="canvas">
                     <div class="canvas__header">
                        <div class="site-header">
                           ...
                           <!--Main Header-->
                           <?php echo $__env->make('templates.default.partials.header', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
                           <!--#Main Header-->
                           <!--Sub header-->
                           <?php echo $__env->make('templates.default.partials.navbar', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
                           <!--#Sub header-->
                        </div>
                        <!--#site_header-->
                     </div>
                     ...
                     <div class="js-canvas__body canvas__body">
                        ...
                        <!--#grid container-->
                        <!--Search-->
                        <?php echo $__env->make('templates.default.partials.searchheader', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
                        <!--#search-->
                        <!--Content-->
                                                      ...
                                                      <div class="course-list__item-thumbnail">
                                                         <div class="item-thumbnail">
                                                            <div class="item-thumbnail__image">
                                                               ...
                                                               <img src="<?php echo e('templates/default/assets/images/courses/cad/csharp-thumb.jpg'); ?>" border="0" height="80" width="150" alt="Moti App PSD Landing Page PSD Template - ThemeForest Item for Sale" title="" class="preload no_preview landscape-image-magnifier" data-tooltip="Moti App PSD Landing Page PSD Template">
                                                               </a>
                                                   ...
                                                   <div class="course-list__column-detail">
                                                      <div class="course-list__item-thumbnail">
                                                         <div class="item-thumbnail">
                                                            <div class="item-thumbnail__image">
                                                               <a class="js-google-analytics__list-event-trigger" href="course-detail.html">
                                                               <img src="<?php echo e('templates/default/assets/images/courses/cad/csharp2-thumb.jpg'); ?>" border="0" height="80" width="150" alt="Moti App PSD Landing Page PSD Template - ThemeForest Item for Sale" title="" class="preload no_preview landscape-image-magnifier" data-tooltip="Moti App PSD Landing Page PSD Template">
                                                               </a>
                                                               <div class="item-thumbnail__preview">
                                                                  <a target="_blank" href="course-detail.html">Xem giới thiệu</a>
                                                               </div>
                                                   ...
                                                   <div class="course-list__column-detail">
                                                      <div class="course-list__item-thumbnail">
                                                         <div class="item-thumbnail">
                                                            <div class="item-thumbnail__image">
                                                               <a class="js-google-analytics__list-event-trigger" href="course-detail.html">
                                                               <img src="<?php echo e('templates/default/assets/images/thumb.jpg'); ?>" border="0" height="80" width="150" alt="Moti App PSD Landing Page PSD Template - ThemeForest Item for Sale" title="" class="preload no_preview landscape-image-magnifier" data-tooltip="Moti App PSD Landing Page PSD Template">
                                                               </a>
                                                               <div class="item-thumbnail__preview">
                                                                  <a target="_blank" href="course-detail.html">Xem giới thiệu</a>
                                                               </div>
                        ...
                        <!--#Content-->
                        <!--Footer-->
                        <?php echo $__env->make('templates.default.partials.footer', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
                        <!--#Footer-->
                     </div>
                     <!--#canvas body-->
                  </div>
