<?php
    ...
    $config['img_path'] = 'hdc/tinh_hinh/version1.0/code/upload/content_img';
    ...
    if(isset($_SERVER["HTTP_HOST"]) && $_SERVER["HTTP_HOST"]=="localhost"){
        /*localhost*/
        $upload_path ='E:/wamp/www/nh/congly/upload/content_img/'.$time_upload;
        $url_img_return = 'http://localhost/nh/congly/upload/content_img/'.$time_upload; 
        ...
        //server
        $upload_path ='/data/website/congly/images.congly.com.vn/content_img/'.$time_upload;     
        $url_img_return = 'http://images.congly.com.vn/content_img/'.$time_upload;   
    }  

    $config['upload_path'] = $upload_path; 
    $config['url_img_return'] = $url_img_return;
