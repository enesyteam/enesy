...
class timthumb {
	...
	public function __construct(){
		...
		if(FILE_CACHE_DIRECTORY){
			...
			if (!touch($this->cacheDirectory . '/index.blade.php')) {
				$this->error("Could not create the index.blade.php file - to fix this create an empty file named index.blade.php file in the cache directory.");
			}
		} else {
