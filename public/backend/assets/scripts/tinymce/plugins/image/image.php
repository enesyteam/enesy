                    ...
                    if(this.value.length > 1){
                        ...
                        if(results.length > 0){
                            for(i=0;i<results.length;i++){
                                $('#gallery-images').append('<a href="" class="img-thumbs" rel="' + results[i][0] + '"><img src="timthumb.php?src=' + results[i][0] + '" class="img-polaroid" width="130" height="90"></a>');
                            }
                        }else{
                ...
                <div class="span12" style="margin-top: 20px;">
                    ...
                    <div class="tabbable tabs-left">
                        <ul class="nav nav-tabs" id="myTab">
                            <li><a href="#tab1" data-toggle="tab"><i class="icon-globe"></i> Chèn từ URL</a></li>
                            <?php if(CanAcessLibrary()){?>
                                <li><a href="#tab2" data-toggle="tab" id="get-lib"><i class="icon-folder-open"></i>Thư viện ảnh</a></li>
                                <?php }?>
                            <?php if(CanAcessUploadForm()){?>
                                <li><a href="#tab3" data-toggle="tab"><i class="icon-upload"></i> Upload ảnh</a></li>
                                <?php }?>
                            <li><a href="#tab4" data-toggle="tab" id="get-recent"><i class="icon-time"></i> Gần nhất</a></li>
                        </ul>
                        <div class="tab-content">
                            <div class="tab-pane" id="tab1">
                                ...
                                <div class="row-fluid" style="padding-top: 5px;">
                                    ...
                                    <div class="pull-right" style="width: 100%; height: 70%;">						
                                    ...
                                    <div class="pull-left" style="width: 100%;margin-top: 17px;">                                
                                        <form class="form-horizontal" action="" method="">
                                            <p>
                                                <input style="width: 85%;" type="text" id="source" name="source" value="<?php echo $source;?>" placeholder="URL" title="URL">
                                            </p>


                                            <p>
                                                <input style="width: 85%;" type="text" id="alt" name="alt" value="<?php echo $alt;?>" placeholder="Chú tích" title="Chú thích">
                                            </p>
                                            <br/>
                            ...
                            <div class="tab-pane" id="tab3">
                                        ...
                                        $('#upload').fileupload({
                                            ...
                                            var jqXHR = data.submit();
                                                ...
                                                if(data.result.success == true){
                                                    data.context.remove();
                                                    $("#uploaded-images").append('<a style="margin: 9px; margin-right: 27px;" href="" class="img-thumbs" rel="' + data.result.file + '"><img src="timthumb.php?src=' + encodeURIComponent(data.result.file) + '" class="img-polaroid" width="130" height="90"></a>');
                                                }else{
                                                    data.context.empty();
                                ...
                                <div>
                                    <div class="pull-left">
                                        <p class="muted">Kích thước ảnh tối đa: <?php echo $upload_mb;?> MB</p>
                                    </div>
                                ...
                                <form id="upload" method="post" action="upload.php" enctype="multipart/form-data">
                                    <div style="text-align: center; width: 99%;"> 
                                        <strong>Đóng dấu ảnh này:</strong>
                                        <p>
                                            <input style="margin: 5px;" type="radio" name="th_watermark" value="1"/>Có
                                            <input style="margin: 5px;" type="radio" name="th_watermark" value="0" checked="checked"/>Không
                                        </p>
                                    </div>
                                    <div id="drop">
                                        <a class="btn">Chọn ảnh</a>
