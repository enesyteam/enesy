        ...
        function BuildDom(src, alt, w, h, title, linkURL, target, float){
            if(imgElm){
                ...
                if(src){
                    ...
                    if(alt){
                        var str_insert_content='<table align="center" cellspacing="0" cellpadding="0" class="th_picture"><tr><td class="th_pic">'+markup+'</td></tr><tr><td class="th_pCaption th_caption">'+ alt +'</td></tr></table>';
                    } else {

                        var str_insert_content='<table align="center" cellspacing="0" cellpadding="0" class="th_picture"><tr><td class="th_pic">'+markup+'</td></tr></table>';

                    }


                    editor.insertContent(str_insert_content);
                }
            }
        }
